...
public class AboutServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		response.getWriter().append("<p>Heather is currently a student at CVTC in the mobile software developer program. In her free time she coaches figure skating and spends as much time with her neice's as possible.</p></section><footer><p>&copy; Heather Johnson 2016</p></footer></body></html>");
	}
